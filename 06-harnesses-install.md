...
>
> **⚠ `v2.10.0` のネイティブ導入では、チーム担当（`Unit Ownership: team`）の Construction が始まらない**（#1286、2026-09-25 追記。修正 `057b13be` は未リリース）。単独運用と手動コピー（Bun）経路は影響しない（→ [19.4](./19-release-impact-2100.md)）。
>
