...
>
> **上げた瞬間に動かなくなるのは 2 つ —— 2.6.121 と 2.6.65 である。**
> どちらも**グラフのコンパイルが拒否される**（2.6.121 はコンポーズも拒否）ので、
> 該当する構成なら移行が済むまで起動しない。**2.6.94 も破壊的**で、
> 改名された内部ヘルパを import しているカスタムツールは import を直すまで動かない。
