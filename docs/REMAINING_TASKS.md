...
- [ ] **次のリリースタグがいつ付くか** — 実装は 2.8.1 だがリリースは 2.8.0 まで。**版番号は未確定**（Copilot / Cursor 修正のコミット本文は 2.8.2、CHANGELOG は 2.8.1）。
...
> **📌 2026-09-17 時点の上流（次回区間の対象）**
>
> | 項目 | 値 |
> |---|---|
> | `main` HEAD | `be94bde7` / `AIDLC_VERSION` = **2.9.0** |
> | 本区間の基準からの差 | **45 コミット / 408 ファイル / +31,268 −4,603** |
> | リリース | v2.8.1（09-09）・v2.8.2（09-11）・**v2.9.0（09-15、Latest）** |
> | preview チャネル | `v2.8.3-preview.20260914.1` / `v2.9.1-preview.20260915.1`（**新設。上流 #1008**） |
> | Copilot / Cursor 不具合 | **v2.8.1 以降で解消済み**（`52da70ad` を含む） |

- [ ] **上流はさらに `be94bde7` / 2.9.0 まで進んだ（2026-09-17 時点。次回区間で扱う）** —— 旧記述: `52da70ad` まで（2026-09-09 時点） —— 3 コミット / 179 ファイル。
