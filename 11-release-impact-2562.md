...
>
> **間隔は一定ではなく、1.110 と 1.115 の間で切り替わっている。**
>
> | 区間 | 版数 / 日数 | ペース |
> |---|---|---|
> | 1.103 → 1.110 | 7 版 / 209 日 | **29.9 日/版**（ほぼ月刊） |
> | 1.110 → 1.115 | 5 版 / 35 日 | **7.0 日/版** |
> | 1.115 → 1.125 | 10 版 / 70 日 | 7.0 日/版 |
> | 1.125 → 1.130 | 5 版 / 35 日 | 7.0 日/版 |
>
> **切り替わりは見出し形式の変更と一致する**（旧「月名 (version x)」→ 新「Visual Studio Code x」）。
> **単一区間から外挿すると矛盾するのは、その区間をまたいで運用が変わっているため**である。
> 見出し形式が旧「月名（version x）」から新「Visual Studio Code x」へ変わっていることも、
> 途中でリリース運用が変わったことを裏づける。
>
