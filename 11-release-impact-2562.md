...
> **VS Code 1.130 の裏取り（2026-08-11）**: 本 PR のレビューで
> 「2026-08 時点では未リリースの版番号ではないか（`1.103` の転記ミスでは）」という指摘を受け、
> 当初は判断を保留していた。**[VS Code の更新履歴](https://code.visualstudio.com/updates/archive)で確認したところ、
> `1.130` は 2026-07-22 リリースの実在する版**だった（`1.103` は 2025-07 で 1 年以上前にあたり、
> 要件としては低すぎる）。**指摘のほうが誤り**で、上流記載が正しい。
...
| 項目 | 内容 |
|---|---|
| 必要バージョン | Copilot CLI ≥ 1.0.74 / **VS Code ≥ 1.130**（1.130 は **2026-07-22 リリース**。AI-DLC 2.5.60 の 2026-08-09 の約 3 週間前） |
