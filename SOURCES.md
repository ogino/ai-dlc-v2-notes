...
3. 同 clone 内（精読・突合済み）:
   ...
   - `core/tools/aidlc-version.ts` → `2.6.123`（2026-08-23 再取得。branch `v2` HEAD `2fbee12f`。初回調査時 `2.5.11` → 2026-08-05 時点 `2.5.37` → 2026-08-10 時点 `2.5.62` → 2026-08-14 時点 `2.6.2` → 2026-08-22 時点 `2.6.49`（HEAD `71d9a9e0`）→ 2026-08-22 時点 `2.6.55`（HEAD `840ba653`））
   ...
   - `docs/guide/glossary.md`（2026-08-23 に再読。**2.6.86 で Bolt の定義が書き換わっている**）
   - `core/` ディレクトリ一覧（stages/tools/hooks/scopes/sensors）
   - 2.6.55 → 2.6.123 区間（2026-08-23 実測。HEAD `2fbee12f`）:
